...
function truephase (k, tphase) {
  ...
  switch (tphase & PHASE_MASK) {
    ...
    case LAST:
      ...
      switch (tphase & PHASE_FIRST_LAST_MASK) {
        case (FIRST & PHASE_FIRST_LAST_MASK):
          pt += 0.0028 - 0.0004 * dcos(m) + 0.0003 * dcos(mprime)
          break

        case (LAST & PHASE_FIRST_LAST_MASK):
          pt += -0.0028 + 0.0004 * dcos(m) - 0.0003 * dcos(mprime)
          break
      }
      break
